...
IMAGE_TAG_BASE ?= opdev.io/simple-java
...
## marker
	cat target/kubernetes/demoresources.tools.opdev.io-v1alpha1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version $(VERSION) $(BUNDLE_METADATA_OPTS)
