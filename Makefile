...
IMAGE_TAG_BASE ?= quay.io/itroyano/simple-java-operator
...
IMG ?= quay.io/itroyano/simple-java-operator
...
docker-build: ## Build docker image with the manager.
	...
	mvn quarkus:image-build -Dquarkus.container-image.image=${IMG}
